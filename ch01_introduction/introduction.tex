...
\textbf{\textit{(i)}~In the \emph{speech} field}, classical \acrfull{ASR} pipelines were traditionally built on Mel-Frequency Cepstral Coefficients \citep{davis1980mfcc} feeding statistical
