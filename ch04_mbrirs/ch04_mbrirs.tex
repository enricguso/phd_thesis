...
we train one \acrshort{SE} model on each one of the RIR datasets (which are summarized in Table \ref{tab:ch4_datasets}) and evaluate it on \emph{real} \acrshortpl{RIR}, both objectively and through a listening test. We find that
